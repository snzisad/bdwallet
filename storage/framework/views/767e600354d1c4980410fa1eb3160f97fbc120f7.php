...
<body class="fix-header fix-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="email-compose.html" href="<?php echo e(asset('/')); ?>"><i class="fa fa-home"></i>Home</a>

                        <li> <a class="email-compose.html" href="<?php echo e(asset('/adminpanel/news')); ?>"><i class="fa fa-info-circle"></i>News and Notice</a>

                        <li> <a class="email-compose.html" href="<?php echo e(asset('/adminpanel/exchangerequest')); ?>"><i class="fa fa-exchange"></i>Exchange Request</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(asset('/adminpanel/depositrequest')); ?>"><i class="fa fa-arrow-circle-down"></i>Deposit Request</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(asset('/adminpanel/withdrawrequest')); ?>"><i class="fa fa-arrow-circle-up"></i>Withdraw Request</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(asset('/adminpanel/gateway')); ?>"><i class="fa fa-paypal"></i>Gateway and Reserve</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(asset('adminpanel/exchangerate')); ?>"><i class="fa fa-money"></i>Exchange Rate</a>
                        </li>
                        <li> <a class="email-compose.html" href="<?php echo e(asset('adminpanel/messages')); ?>"><i class="fa fa-envelope-o"></i>Messages</a>
                        </li>
                    </ul>
                </nav>
    ...
    <script src="<?php echo e(asset('content/js/adminpanel.js')); ?>"></script>
